...
import sys
# sys.path.append('/home/oscar/Dropbox/InterFuser/carla/PythonAPI/carla/dist/carla-0.9.10-py3.7-linux-x86_64.egg')
# sys.path.append('/home/oscar/Dropbox/InterFuser/carla/PythonAPI/carla')
# sys.path.append('/home/oscar/Dropbox/InterFuser/carla')
# sys.path.append('/home/oscar/Dropbox/InterFuser/leaderboard/team_code')
# sys.path.append('/home/oscar/Dropbox/InterFuser/leaderboard')
sys.path.append('/home/spyder/Dropbox/InterFuser/scenario_runner')
# sys.path.append('/home/oscar/Dropbox/InterFuser/corl')
...
def main():
    ...
    parser.add_argument('--trafficManagerSeed', default='3407',
                        help='Seed used by the TrafficManager (default: 0)')
    parser.add_argument('--carlaProviderSeed', default='3407',
    ...
    parser.add_argument('--routes',
                        ...
                        default='/home/oscar/Dropbox/VisionFoundationVehicle/leaderboard/data/validation_routes/routes_town04_short.xml')
    ...
    parser.add_argument('--scenarios',
                        ...
                        default='/home/oscar/Dropbox/VisionFoundationVehicle/leaderboard/data/scenarios/town04_all_scenarios.json')
    ...
    parser.add_argument("-a", "--agent", type=str, help="Path to Agent's py file to evaluate",
                        default="/home/oscar/Dropbox/VisionFoundationVehicle/corl/carla_evaluate/corl_agent.py")
    parser.add_argument("--agent-config", type=str, help="Path to Agent's configuration file",
                        default="/home/oscar/Dropbox/VisionFoundationVehicle/corl/corl_config.py")
  
    parser.add_argument("--track", type=str, default='SENSORS', help="Participation track: SENSORS, MAP")
    parser.add_argument('--resume', type=bool, default=False, help='Resume execution from last checkpoint?')
    parser.add_argument("--checkpoint", type=str,
                        default='/home/oscar/Dropbox/VisionFoundationVehicle/results/corl_result_town04_202471205440.json',
