...
from benchmark.constants import LINGO_JUDGE, Keys
...
class LingoJudge(nn.Module):
    ...
    def __init__(self, pretrained_model=LINGO_JUDGE):
        ...
        # self.tokenizer = AutoTokenizer.from_pretrained("/mnt/nas/share2/home/gzh/code/LingoQA/model_pretrained", use_fast=True)
        # self.model = AutoModelForSequenceClassification.from_pretrained("/mnt/nas/share2/home/gzh/code/LingoQA/model_pretrained").eval()
